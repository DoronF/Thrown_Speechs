...
### Libraries
```{r setup, message=FALSE, warning=FALSE, code_folding="none"}
# Required Libraries
...
```{r configuration, code_folding="none"}
...
![This is a screenshot of a PDF document.](data/pdf_screenshot.png)
